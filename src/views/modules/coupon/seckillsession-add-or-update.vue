<template>
  <el-dialog
    ...
    <el-form-item label="每日开始时间" prop="startTime">
        <el-date-picker v-model="dataForm.startTime" type="datetime" placeholder="每日开始时间"></el-date-picker>
      <!-- <el-input v-model="dataForm.startTime" placeholder="每日开始时间"></el-input> -->
    </el-form-item>
    <el-form-item label="每日结束时间" prop="endTime">
      <el-date-picker v-model="dataForm.endTime" type="datetime" placeholder="每日结束时间"></el-date-picker>
    ...
    <el-form-item label="启用状态" prop="status">
     ...
     <!-- <el-form-item label="创建时间" prop="createTime">
      <el-date-picker v-model="dataForm.createTime" type="datetime" placeholder="创建时间"></el-date-picker>
