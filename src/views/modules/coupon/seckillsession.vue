<template>
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="relationHandle(scope.row.id)">关联商品</el-button>
    ...
    <relation v-if="relationVisivle" ref="relation"></relation>
  </div>
</template>

<script>
  import AddOrUpdate from './seckillsession-add-or-update'
  import Relation from './seckillskurelation'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      // 关联商品
      relationHandle(id){
        this.relationVisivle = true
        this.$nextTick(() => {
          this.$refs.relation.init(id)
        })
      },
      // 删除
      deleteHandle (id) {
