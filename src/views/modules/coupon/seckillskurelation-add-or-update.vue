<template>
  ...
  append-to-body
    ...
    <el-form-item label="活动场次id" prop="promotionSessionId">
      <el-input  :disabled="dataForm.id?true:false" v-model="dataForm.promotionSessionId" placeholder="活动场次id"></el-input>
    </el-form-item>
    <el-form-item label="商品id" prop="skuId">
      <el-input v-model="dataForm.skuId" placeholder="商品id"></el-input>
    </el-form-item>
    <el-form-item label="秒杀价格" prop="seckillPrice">
      <el-input-number :precision="2" :step="0.1" v-model="dataForm.seckillPrice" placeholder="秒杀价格"></el-input-number>
    </el-form-item>
    <el-form-item label="秒杀总量" prop="seckillCount">
      <el-input-number v-model="dataForm.seckillCount" placeholder="秒杀总量"></el-input-number>
    </el-form-item>
    <el-form-item label="每人限购数量" prop="seckillLimit">
      <el-input-number v-model="dataForm.seckillLimit" placeholder="每人限购数量"></el-input-number>
    </el-form-item>
